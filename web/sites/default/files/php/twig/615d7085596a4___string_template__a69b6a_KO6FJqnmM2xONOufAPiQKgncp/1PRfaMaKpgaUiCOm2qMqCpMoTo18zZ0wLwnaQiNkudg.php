...
class __TwigTemplate_760193c624ed2353981e2a116642e973f172d9273504b80e22df4bea6c307da9 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}<a href=\"#\" class=\"cke-icon-only cke_{{ direction }}\" role=\"button\" title=\"{{ name }}\" aria-label=\"{{ name }}\"><span class=\"cke_button_icon cke_button__{{ classname }}_icon\">{{ name }}</span></a>", "__string_template__a69b6adda56a5d8356cc3cafe6107ea084905252d8f966c17330f4b1ab1436eb", "");
    }
